module Day10.Day10 where
    ...
    findNoCellsInsidePipes :: Vector (Vector Char) -> [(Int, Int)] -> Int
    findNoCellsInsidePipes grid pipeLocations = sum (imap (\i x -> findNoCellsInsidePipesOnLine x i pipeLocations) grid)

    findNoCellsInsidePipesOnLine :: Vector Char -> Int -> [(Int, Int)] -> Int
    ...
    processCellForParity :: (Int, Bool) -> Int -> Char -> Int -> [(Int, Int)] -> (Int, Bool)
